...
export const RESTORATION_MILESTONES: RestorationMilestone[] = [
  ...
  { id: 'sweet-corn-restored', requiredLevel: 15, title: "Restore Frankland's Corn Fields", description: 'The farm shines again and the road to Cayon Creek opens.', coins: 250, tools: { scarecrow: 1, butterBrush: 1 } },
  ...
  { id: 'crow-creek-restored', requiredLevel: 30, title: 'Restore Cayon Creek', description: 'The scarecrow line holds and the mill road opens toward the orchard.', coins: 300, tools: { scarecrow: 1, cornPicker: 1 } },
  ...
  { id: 'orchard-restored', requiredLevel: 45, title: 'Restore Fig Tree Hollow', description: "The mill garden shines and lanterns point to Pinney's Maize.", coins: 350, tools: { butterBrush: 1, cornPicker: 1 } },
  ...
  { id: 'moonlight-restored', requiredLevel: 60, title: "Restore Pinney's Maize", description: 'The Harvest Festival can begin with every farm shining.', coins: 500, tools: { scarecrow: 1, butterBrush: 1, cornPicker: 1 } },
];
